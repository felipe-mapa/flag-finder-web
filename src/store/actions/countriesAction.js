...
export const fetchCountries = () => {
    return async dispatch => {
        try {
            ...
            // CHANGE const route = `/wp-json/wp/v2/continents/`;
            ...
            // Load countries
            // CHANGE const route1 = `/wp-json/wp/v2/country/?per_page=100&page=1&order=asc&orderby=title`;
            const route1 = `http://flagfinderapp.com/wp-json/wp/v2/country/?per_page=100&page=1&order=asc&orderby=title`;
            // CHANGE const route2 = `/wp-json/wp/v2/country/?per_page=100&page=2&order=asc&orderby=title`;
            const route2 = `http://flagfinderapp.com/wp-json/wp/v2/country/?per_page=100&page=2&order=asc&orderby=title`;
            // CHANGE const route3 = `/wp-json/wp/v2/country/?per_page=100&page=3&order=asc&orderby=title`;
...
export const fetchCountry = (countryName) => {
    return async dispatch => {
        try {
            // Load continents for countries
            // CHANGE const contiRoute = `/wp-json/wp/v2/continents/`;
            ...
            // Load country
            // CHANGE const route = `/wp-json/wp/v2/country/?slug=` + countryName;
...
export const fetchTags = () => {
    return async dispatch => {
        try {
            // CHANGE const route1 = `/wp-json/wp/v2/countryTags/?per_page=100&page=1`;
            const route1 = `http://flagfinderapp.com/wp-json/wp/v2/countryTags/?per_page=100&page=1`;
            // CHANGE const route2 = `/wp-json/wp/v2/countryTags/?per_page=100&page=2`;
